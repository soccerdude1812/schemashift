...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Try to sign in immediately — if email confirmation is required,
      // the user will get an appropriate message.
      ...
      if (signInError) {
        // If the error is about email confirmation, show a friendly message
        ...
        // For auto-confirmed accounts that just worked, redirect
        ...
        <Card className="border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-zinc-400">
              Get started with SchemaShift for free
            </CardDescription>
          </CardHeader>
          <CardContent>
